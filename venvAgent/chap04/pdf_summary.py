...
def pdf_to_text(pdf_file_path: str):
    ...
    txt_file_path = f'venvAgent\chap04\output\{pdf_file_name}_with_preprocessing.txt'
...
if(__name__ == '__main__'):
    pdf_file_path = r"venvAgent\chap04\data\testPDF.pdf"
    summarize_pdf(pdf_file_path, r"venvAgent\chap04\output\crop_model_summary2.txt")