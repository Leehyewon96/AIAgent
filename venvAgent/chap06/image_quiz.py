...
load_dotenv()
api_key = os.getenv('OPENPI_API_KEY')
...
for g in glob('./chap06/data/*.jpg'):
    ...
    with open('./chap06/data/image_quiz.md', 'w', encoding='utf-8') as f:
        f.write(txt)
        ...
        with open('./chap06/data/image_quiz_eng.json', 'w', encoding='utf-8') as f:
